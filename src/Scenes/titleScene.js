...
export default class TitleScene extends Phaser.Scene {
  ...
  create() {
    // First level
    this.gameButton = new Button(this, config.width / 2, config.height / 2 - 150, 'blueButton1', 'blueButton2', 'Play First', 'Level-1');

    // Choose level
    this.gameButton = new Button(this, config.width / 2, config.height / 2 - 50, 'blueButton1', 'blueButton2', 'Choose', 'Levels');
